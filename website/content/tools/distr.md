...
description: The Open Source control plane for self-managed, BYOC, and on-prem deployments.
  ...
  the box.
homepage_url: https://distr.sh/
layout: single
letter: D
project_name: Distr
repo_url: https://github.com/distr-sh/distr
status: in_progress
summary: The Open Source control plane for self-managed, BYOC, and on-prem deployments.
  Everything you need to distribute applications to self-managed customers out of
  the box.
title: Distr
---
