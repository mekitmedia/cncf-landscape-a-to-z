...
homepage_url: https://docs.sighup.io
layout: single
letter: S
project_name: SIGHUP Distribution
repo_url: https://github.com/sighupio/distribution
status: in_progress
summary: SIGHUP Distribution is a battle-tested distribution purely based on upstream
  Kubernetes. Deploy and manage a stable and production grade Kubernetes Cluster at
  scale with a comprehensive Cloud Native stack implemented with top notch CNCF components.
