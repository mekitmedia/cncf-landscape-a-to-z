...
layout: single
letter: D
project_name: Desktop Kubernetes
repo_url: https://github.com/aceeric/desktop-kubernetes
status: in_progress
summary: Stands up a three-VM Kubernetes development cluster on the desktop using
  VirtualBox, by running a single Bash script.
