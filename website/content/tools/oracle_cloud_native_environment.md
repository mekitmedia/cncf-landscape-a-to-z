...
homepage_url: https://www.oracle.com/linux/cloud-native-environment/
layout: single
letter: O
project_name: Oracle Cloud Native Environment
repo_url: https://github.com/oracle-cne/ocne
status: in_progress
summary: Oracle Cloud Native Environment is a fully integrated suite for the development
  and management of cloud-native applications that uses Kubernetes to orchestrate
  and schedule containers.
