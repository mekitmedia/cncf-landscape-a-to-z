...
layout: single
letter: F
project_name: Flomesh Service Mesh (FSM)
repo_url: https://github.com/flomesh-io/fsm
status: in_progress
summary: Lightweight SMI compatible service mesh for Kubernetes east-west and north-south
  traffic management, uses ebpf for layer4 and pipy proxy for layer7 traffic management,
  support multi cluster network.
