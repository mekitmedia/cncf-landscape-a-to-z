...
class Cli:
  def run(self, input_path="https://raw.githubusercontent.com/cncf/landscape/master/landscape.yml", output_dir="data", content_dir="website/content"):
    ...
    generate_letter_pages(output_dir=content_dir, summaries=summaries)
