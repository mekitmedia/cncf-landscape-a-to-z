"""Centralized system prompts shared across Pydantic AI agents, GitHub Actions, and portable skills."""
...
CONTENT_MANAGER_SYSTEM_PROMPT = """You are a Content Manager aiming for the completeness of the CNCF landscape.
